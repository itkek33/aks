...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"eed98b45-abda-4b0d-9817-f6a9aeb5c573\00", align 16
...
@__DSOCacheEntry_name.8 = internal constant [23 x i8] c"libaot-YourCity.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 7
	%struct.DSOCacheEntry {
		i64 231445912893699227, ; hash 0x33642d4debeb49b, from name: YourCity.dll.so
		i8 0, ; ignore
	...
	; 96
	%struct.DSOCacheEntry {
		i64 4077099607670812211, ; hash 0x3894c47de51a6e33, from name: aot-YourCity.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 130
	%struct.DSOCacheEntry {
		i64 6176204026693905644, ; hash 0x55b648d6df6d6cec, from name: YourCity
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 189
	%struct.DSOCacheEntry {
		i64 8383198190559693900, ; hash 0x74571a5696020c4c, from name: aot-YourCity
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 252
	%struct.DSOCacheEntry {
		i64 10696191805356191136, ; hash 0x947081c6afb32da0, from name: libaot-YourCity
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 318
	%struct.DSOCacheEntry {
		i64 13061817347817668390, ; hash 0xb544e5ac61b4ff26, from name: libaot-YourCity.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
